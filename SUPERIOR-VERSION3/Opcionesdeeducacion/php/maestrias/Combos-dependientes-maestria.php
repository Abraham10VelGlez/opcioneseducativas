...
$maestrias=$_GET['cccc'];
echo "<input id='password5' type='hidden' value='".$maestrias."' />";
$magi=str_replace(" ", "+", $maestrias);
$key='';
...
//die();
    ?>
  <?php $nom=$conector->query("SELECT ki9119b.NOMBRECAR FROM ki9119b where ki9119b.CARRERA='$id_category' AND ki9119b.CARRERA LIKE '7%';");
...
<body id="container">
                        ...
                        <div class="row-fluid">
                            ...
                            <a class="btn btn-success" id="evaluar5"><i class="fa fa-print">Descargar excel</i></a>
                            </div>
                        </div>                          
