...
select ki9119b.CLAVEINSTI,Ki9119b.NOMINSTI,ki9119b.CLAVECCT,ki9119b.NOMBREESC,ki9119b.CARRERA,ki9119b.NOMBRECAR,ki9119b.DOMICILIO,ki9119b.COLONIA,ki9119b.TELEFONO,trim(ki9119b.CORREO),ki9119b.TIPO,trim(ki9119b.NOMBREMUN),ki9119b.CONTROL,ki91110.NOMDIREC,ki91110.FAX,ki91110.NOMBRELOC,ki9119b.PAGINA_WEB,ki9119b.S2
 from ki9119b inner join ki91110 on ki9119b.CLAVEINSTI=ki91110.claveinsti where ki9119b.MUNICIPIO='$MA') as h;
	...
	if($resultado->num_rows > 0 ){
		...
		$titulosColumnas = array('CARRERAS','CLAVE','INSTITUCION','CCT','ESCUELA','DOMICILIO','LOCALIDAD','MUNICIPIO','TELEFONO','DIRECTOR','CONTROL','TIPO','CORREO','RVOE','REDES SOCIALES');
...
//
$correoo = strstr($fila['trim(ki9119a.CORREO)'], ' ', true); // Desde PHP 5.3.0
if(empty($correoo)){ $correoo="SIN CORREO";}  else {
$correoo=  $fila['trim(ki9119a.CORREO)'];
} // mostrará SOLO LA PALABRAS HASTA DONDE HAYA UN ESPACIO...
...
->setCellValue('F'.$i, utf8_encode($domicilioo))
->setCellValue('G'.$i, utf8_encode($user))
...
->setCellValue('M'.$i, utf8_encode($correoo))
->setCellValue('N'.$i, utf8_encode($rvoevacio))
->setCellValue('O'.$i, utf8_encode($pweb));
                                    $i++;
